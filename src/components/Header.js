    ...
    return(
        <div className="w-screen px-8 py-2 bg-gradient-to-b from-black z-10 absolute flex justify-between">
            ...
            alt = "netflixLogo" />
            {
                user && 
                <div className="flex">
                <img src= "https://occ-0-4994-2186.1.nflxso.net/dnm/api/v6/vN7bi_My87NPKvsBoib006Llxzg/AAAABaZZV8QprnSGoWY58RwakvjGHrMbgAo3hTkb8sc-cwfbQY75QV-vNBdqO1MyvugLSYP-08yb6b_xQdDnDDHe5OJ33WozDiQ.png?r=558"
                alt = "icon" 
